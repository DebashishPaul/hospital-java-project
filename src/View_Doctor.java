...
public class View_Doctor implements ActionListener {
	JFrame frame;
	JLabel nameL, genderL, nidL, ageL, phoneL, emailL, addressL, roomL, salaryL;
	JTextField name, gender, nid, age, phone, email, address, room, salary;
	JButton back,exit;

	public View_Doctor(String n, String g, String id, String a, String p, String em, String ad, String r, String s) {
	...
	public static void main(String[] args) {
		new View_Doctor(null, null, null, null, null, null, null, null, null);
	}
