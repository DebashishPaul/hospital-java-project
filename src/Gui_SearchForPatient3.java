...
public class Gui_SearchForPatient3 implements ActionListener {
			...
			for (int i = 0; i < Gui_Open.patient.length; i++) {
				if (Gui_Open.patient[i] != null) {
					if (Gui_Open.patient[i].getNid() == x) {
						...
						new View_Parent3(Gui_Open.patient[i].getName(), Gui_Open.patient[i].getGender(), nid, AGE,
