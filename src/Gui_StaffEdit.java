...
public class Gui_StaffEdit implements ActionListener {
	JFrame frame;
	JLabel optionL, nidL;
	JComboBox option;
	JLabel updateL;
	...
	public Gui_StaffEdit() {
		Font f1 = new Font("Arial", Font.BOLD, 21);
		Font f2 = new Font("Arial", Font.PLAIN, 21);

		frame = new JFrame("Edit information of a staff");
		frame.setBounds(280, 150, 750, 400);

		GridLayout g = new GridLayout(4, 2);
		frame.setLayout(g);

		nidL = new JLabel("Staff's NID ");
		nidL.setFont(f1);
		nid = new JTextField();
		nid.setFont(f2);
		String[] x = { "Name", "Address", "Phone", "Email", "Age", "Salary"};
