...
import javax.swing.*;
public class Gui_StaffSelection implements ActionListener{
	JFrame frame;
	JLabel title;
	JButton add,delete,search,back,exit;
	public Gui_StaffSelection() {
		frame = new JFrame("Staff's Selection");
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(e.getSource() == search){
			frame.setVisible(false);
			new Gui_SearchforStaff();
		}
		if(e.getSource() == delete){
			frame.setVisible(false);
			new Gui_DeleteForStaff();
		}
